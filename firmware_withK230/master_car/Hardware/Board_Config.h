...
/* Project hardware abstraction: encoder interrupt IRQ number.
 * Encoder.c must use ECAR_ENCODER_IRQN, never a raw SysConfig macro. */
#ifdef GPIO_ENCODER_INT_IRQN
#define ECAR_ENCODER_IRQN               GPIO_ENCODER_INT_IRQN
#else
#error "GPIO_ENCODER_INT_IRQN not generated by SysConfig. Check empty.syscfg encoder GPIO interruptEn setting."
#endif
...
#define JY61P_UART_BAUD_RATE            UART_JY61P_BAUD_RATE
#define JY61P_UART_IRQHandler           UART_JY61P_INST_IRQHandler
