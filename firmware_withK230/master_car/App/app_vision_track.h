...
#define VISION_TRACK_MAX_SPEED_CMPS          18.0f
#define VISION_TRACK_MIN_SPEED_CMPS           9.0f
...
#define VISION_TRACK_CURVE_HOLD_SPEED_CMPS   14.0f
...
#define VISION_TRACK_EY_FULL_SLOW_MM         60.0f
#define VISION_TRACK_EA_FULL_SLOW_DEG        16.0f
...
#define VISION_TRACK_DECEL_STEP_CMPS          1.20f
#define VISION_TRACK_ACCEL_STEP_CMPS          0.60f
#define VISION_TRACK_TURN_STEP_CMPS           0.45f
